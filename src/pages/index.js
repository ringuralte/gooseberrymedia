      ...
      <div className={homeStyles.wrapper}>
        ...
        <div className={homeStyles.home}>
          <div className={homeStyles.headlineText}>
            <div className={homeStyles.headlineTextWrapper}>
              ...
              <h2 className={homeStyles.headlineTextUpper}>
                {" "}
                Turn your Dreams{" "}
              </h2>
        ...
        <div className={homeStyles.heroText}>
          <p>
            ...
            set up to make your dreams into reality.{" "}
        ...
        <div className={homeStyles.videoWrapper}>
          <h4>
            With{" "}
            <a href="https://www.youtube.com/channel/UCODBFuwgRzdFrN-H6HPKBbw/">
              ScreenFarm{" "}
            </a>
            and{" "}
            <a href="https://www.youtube.com/channel/UCFuSIUe7CLS2XAucmQLD6rQ">
              Avora Records
            </a>
          </h4>
          <iframe
            className={homeStyles.videoContent}
            src="https://www.youtube.com/embed/tqtQ6L9IYWA"
            frameborder="0"
