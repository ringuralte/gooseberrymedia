    ...
    <Layout>
      ...
      <div className={aboutStyles.wrapper}>
        <div className={aboutStyles.block}>
          ...
          <p>
            Gooseberry studio is a state of the art recording and video studio
            set up to take your dreams into realities. For experienced and
            amateurs alike you will find us as a friendly team who can record
            and produce your music, videos and films professionally.
          </p>
          <p>
            We also have a fully equipped two bedroom country cottage for those
            wanting to spend more time on their projects.
          </p>
          <p>
            The studio is set in the beautiful Sunhlukawn Country Park which is
            a natural jungle environment with lake, boating and country walks.
            Fishing is also available, with all fishing tackle for our
            registered guests.
          </p>
          <h2>Equipments Available</h2>
          <p>
            The recording studio has two main mixer desks, a Peavey 32FX-E
            powered console and a Soundcraft Signature 22 MTK (Multi-track)
            Analog mixer. This enables a massive 54 tracks to be recorded with
            up to 22 individual live tracks. The mixers feed multimedia
            computers through a range of professional software.
          </p>
          <p>
            The studio complex has comfortable seating, a vocal booth, control
            room with coffee bar and comfy sofas!
          </p>
          <h3>Drums</h3>
          <ul>
